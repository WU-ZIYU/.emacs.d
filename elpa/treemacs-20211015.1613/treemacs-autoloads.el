...
Jump back to the previously used window if point is already in treemacs." t)
...
only project, all other projects *will be removed* from the current workspace." t)

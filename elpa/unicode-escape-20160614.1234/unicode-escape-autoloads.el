;;; unicode-escape-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
convert to surrogate pairs." (cl-assert (char-or-string-p obj) t) (if (characterp obj) (-escape-char obj surrogate) (let ((case-fold-search nil)) (replace-regexp-in-string -re-unicode #'(lambda (s) (-escape s surrogate)) obj t t)))) (defun -escape-object* (obj) "Escape unicode characters disable surrogate pair in OBJ.
...
(register-definition-prefixes "unicode-escape" '("-escape" "-pa" "-re-" "-un"))

;;; End of scraped data

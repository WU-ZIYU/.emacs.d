...
Create an ephemeral live-updating Embark Collect buffer." t)
...
Switch to the Embark Collect Completions buffer, creating it if necessary." t)
(autoload 'embark-export "embark" "\
Create a type-specific buffer to manage current candidates.
The variable `embark-exporters-alist' controls how to make the
buffer for each type of completion." t)
